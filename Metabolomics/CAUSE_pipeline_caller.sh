### CAUSE_pipeline_caller for multiple exposure & outcome phenotypes
### DATE: 2021-OCT-15
### AUTHOR: XIN LIN
...
cat << __EOT__ > CAUSE_MS_run_list${k}.sh
...
## usage: Rscript cause_model.R arg1 arg2 arg3 arg4 arg5 arg6
## arg1: working direcotry for pipeline
...
## arg6: file path for reference dataset
## arg7: p-value threshold

### Required data columns
##exp: Chr, BP, SNP, A1, A2, a1_freq, BETA, SE, P, N
##out: Chr, BP, SNP, A1, A2, a1_freq, BETA, SE, P, N

Rscript /u/xlin8/metabolism/pipeline2/CAUSE_pipeline.R \
